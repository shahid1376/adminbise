...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <br />
                        ...
                        <div class="persnal_info">
                            ...
                            <form name="std_fth_dob_frm" id="std_fth_dob_frm" action="<?=base_url()?>/index.php/Privateslips/GetpvtRSlip" method="post">
                                <fieldset >
                        ...
                        <div class="Form_NO">
                            ...
                            <form name="formno" id="formno" action="<?=base_url()?>/index.php/Privateslips/GetpvtRSlip" method="post">
                                <fieldset>
                                    <div class="student_info">
                        ...
                        <div class="Roll_NO">
                            ...
                            <form name="cur_exm_roll_frm" id="cur_exm_roll_frm" action="<?=base_url()?>/index.php/Privateslips/GetpvtRSlip/" method="post">
                                <fieldset>
                                    <div class="student_info">
